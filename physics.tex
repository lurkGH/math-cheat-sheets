...
\normalsize{\centerline{\textbf{\underline{Gravitational Constant}}}}
\[G = 6.674 \times 10^{-11}\]
...
\small{\centerline{(Change in Potential Energy $U$ = mass$_{object} \cdot$ gravity $\cdot$ Displacement = -Work$_{gravity}$)}}
